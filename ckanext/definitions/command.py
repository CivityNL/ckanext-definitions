...
import ckanext.definitions.model as definitions_model


class InitDBCommand(p.toolkit.CkanCommand):
    '''
    Usage:
        paster definitions [initdb]
    ...
    def initdb(self):
        ...
        '''
        definitions_model.create_table()

    def cleandb(self):
        '''
        Delete information from table defined by model
        '''
        definitions_model.delete_table()

    def dropdb(self):
        '''
        Drop table defined by model
        '''
        definitions_model.drop_table()