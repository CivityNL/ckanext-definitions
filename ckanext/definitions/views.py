...
definition.add_url_rule('/<definition_id>/activity', view_func=DefinitionController.activity, methods=['GET'])
definition.add_url_rule('/<definition_id>/activity/<int:offset>', view_func=DefinitionController.activity, methods=['GET'])
definition.add_url_rule('/<definition_id>', view_func=DefinitionController.read, methods=['GET'])
...
dataset_definition = Blueprint('package_definition', __name__, url_prefix='/dataset/<package_id>/definition')
dataset_definition.add_url_rule('/', view_func=PackageDefinitionController.read, methods=['GET'])
dataset_definition.add_url_rule('/edit', view_func=PackageDefinitionController.edit, methods=['GET', 'POST'])
dataset_definition.add_url_rule('/new', view_func=PackageDefinitionController.new, methods=['GET', 'POST'])
dataset_definition.add_url_rule('/<definition_id>/delete', view_func=PackageDefinitionController.delete, methods=['GET', 'POST'])
